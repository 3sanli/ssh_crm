				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							<tr>
								<td>所属客户：</td>
								<td><input type="text" id="custNameInput" value="<s:property value='#linkMan.cust.cust_name' />" style="WIDTH: 180px"/></td>
								<td><input type="button" value="选择客户" onclick="selectCustomer()" /></td>
								<input type="hidden" id="custIdInput" value="<s:property value='#linkMan.cust.cust_id' />" name="cust.cust_id" />
								<input type="hidden" value="<s:property value='#linkMan.lkm_id' />" name="lkm_id" />
							</tr>
							<TR>
								<td>联系人名称：</td>
								<td>
								...
								<input type="radio" value="2" <s:property value="#linkMan.lkm_gender=='2'?'checked':''" /> name="lkm_gender">女
								</td>
							</TR>
							<TR>
								<td>联系人办公电话 ：</td>
